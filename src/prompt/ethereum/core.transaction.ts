...
export function createEthereumCoreTransactionSchema(): FlipsideSchema {
  ...
  const TableSchema =
    'BLOCK_HASH text, BLOCK_NUMBER number, BLOCK_TIMESTAMP timestamp_ntz, CUMULATIVE_GAS_USED float, ETH_VALUE float, FROM_ADDRESS text, GAS_LIMIT number, GAS_PRICE float, GAS_USED float';
